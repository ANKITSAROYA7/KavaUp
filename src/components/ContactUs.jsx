                    ...
                    <div className=' max-w-[951px] mx-auto'>
                        <div className="flex items-end flex-wrap mx-[-12px] justify-center ">
                            <div className=' lg:w-[42%] px-3  -mt-[177px] flex max-lg:order-last'>
                                <img className='translate-y-[199px] sm:translate-y-[218px] lg:translate-y-[177px] max-w-[300px] sm:max-w-[315px] lg:hover:translate-y-[150px] transition-all duration-300' src={phonepic} alt="#" />
                            </div>
                            <div className=' lg:w-[58%] px-3 lg:pt-20 lg:pb-[60px] '>
                                ...
                                <button className=' font-poppins font-medium text-lg leading-[21px] text-white px-10 py-5 bg-gradient-to-l from-[#0055B2] to-[#D0006F] rounded-[50px] mt-5 lg:mt-[30px] hover:scale-[1.05] transition-all duration-300 '>Contact Us</button>
                            </div>
                        </div>
                    </div>
                </div>
