            ...
            <div className="container lg:!max-w-[1182px] px-3 mx-auto">
                <nav className=' pt-[23px] pb-6 sm:pb-10 lg:pb-[123px]'>
                    <div className=' flex justify-between items-center'>
                        ...
                        <ul className={`${show ? " !left-[0px] bg-[#ffff]" : ""} z-40 flex gap-[40px] flex-col min-h-screen w-full top-0 bottom-0 fixed justify-center items-center left-full lg:static lg:w-auto lg:min-h-full lg:flex-row transition-all duration-500 `}>
                            <li><a onClick={() => setShow(!show)} href="#" className='text-[#131619] font-poppins font-medium text-lg leading-[21px]'>Home</a></li>
                            <li><a onClick={() => setShow(!show)} href="#" className='text-[#131619] font-poppins font-medium text-lg leading-[21px]'>Apps</a></li>
                            <li><a onClick={() => setShow(!show)} href="#" className='text-[#131619] font-poppins font-medium text-lg leading-[21px]'>Solutions</a></li>
                            <li><a onClick={() => setShow(!show)} href="#" className='text-[#131619] font-poppins font-medium text-lg leading-[21px]'>Services</a></li>
                            <li><a onClick={() => setShow(!show)} href="#" className='text-[#131619] font-poppins font-medium text-lg leading-[21px]'>Contact Us</a></li>
                        </ul>
                ...
                <div className=' flex flex-wrap mx-[-12px] items-center 2xl:items-start justify-center '>
                    <div className=' lg:w-6/12 px-3'>
                        ...
                        <button className=' font-poppins font-medium text-lg lg:leading-[21px] text-white px-10 py-5 bg-gradient-to-l from-[#0055B2] to-[#D0006F] rounded-[50px]'>Read More</button>
                    </div>
